/*global TrainTracker _config AmazonCognitoIdentity AWSCognito*/
...
(function scopeWrapper($) {
  ...
  TrainTracker.signOut = function signOut() {
    userPool.getCurrentUser().signOut();
  };

  TrainTracker.authToken = new Promise(function fetchCurrentAuthToken(resolve, reject) {
